...
<div id="main" class="clearfix">
    <div class="signIn">
        <div class="clearfix mt-no-20 mb-no-20">
            <div class="fl-no yellow" style="font-size:18px;">账户注册</div>
            <div class="fr-no size"><a href="<?php echo  site_url("User/index") ;?>">登录</a></div>
        </div>
        <form role="form" action="https:www.baidu.com" id="registerForm" method="get">
            ...
            <div class="form-group ste_text">
                <label for="" class="label_no">登录密码</label>
                <input type="password" placeholder="密码" id="password" name="password">
                <div class="text_vftn"></div>
            </div>
            <div class="form-group ste_text">
                <label for="" class="label_no">确认密码</label>
                <input type="password" placeholder="确认密码" id="confirm_password" name="confirm_password">
                <div class="text_vftn"></div>
            </div>
            <div class="form-group verification">
                <label for=""  class="label_no">输入验证码</label>
                <input   id="pictureVerification"  placeholder="验证码" name="pictureVerification" type="text">
            ...
            <div class="form-group ste_text">
                <label for="" class="label_no">输入推荐码</label>
                <input type="text" placeholder="输入推荐码(选填)" id="recommended" name="">
            </div>
            <div class="form-group checkbox red">
                <label for="agree">
                    <input type="checkbox" id="agree" name="agree">阅读并同意
                </label>
                <a href="<?php  echo  base_url('Aboutus/service');?>">服务协议</a>
                <div class="text_vftn"></div>
            </div>
            <input type="submit" class="btn-yellow" value="注册">
        </form>
    </div>
</div>
<!-- 主体 END -->
