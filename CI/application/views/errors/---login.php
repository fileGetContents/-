...
<body>
    <div class = '_center'>
        ...
        <div class = '_register'>
            <form id = 'register' action="<?php echo site_url("User/userLogin");?>" method="post">
                <table class = "table">
                    <tr><td><font size="7">用户登录</font></td></tr>
                    ...
                    <tr><td><div style = 'position:relative;height: 37px'><img style = 'position:absolute;right:43%;' onclick="this.src = '<?php echo site_url("User/Verify");?>'" src="<?php echo site_url("User/Verify");?>">
                                <input class = "code" name="code" id="code" type="text" placeholder="请输入验证码" /></div></td></tr>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
                    <tr><td></td></tr>
