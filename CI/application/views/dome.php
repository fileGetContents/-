...
<div id="main">
    <div class="container-fluid ctr_bgd">
        ...
        <div class="nav_product">
            <a href="<?php echo site_url('Dome/index');?>" class="active">全部项目</a><a href="<?php echo site_url('Dome/domeo');?>">筹集中</a><a href="<?php echo site_url('Dome/domew');?>">已完成</a><a href="<?php echo site_url('Dome/domef');?>">预约中</a>
        </div>
    </div>
                ...
                <div class="thumbnail">
                    <a href="<?php echo  site_url('Project/index') ?>?id=<?php echo  $value['project_id'];?>">
                        ...
                        if($value['project_tag']==0){
                            ...
                            echo   '<div class="pgss_time">结束时间：<span>'.$value['project_time_over'].'</span></div>';
                        }else{
                            echo  '<div class="pgss_time">开始时间：<span>'.$value['project_time_start'].'</span></div>';
                        }
                        ?>
