...
<div id="main">
    <div class="container-fluid ctr_bgd">
        ...
        <div class="nav_product">
            <a href="<?php echo site_url('Dome/index');?>" >全部项目</a><a href="<?php echo site_url('Dome/domeo');?>">筹集中</a><a href="<?php echo site_url('Dome/domew');?>" class="active">已完成</a><a href="<?php echo site_url('Dome/domef');?>">预约中</a>
        </div>
    </div>
